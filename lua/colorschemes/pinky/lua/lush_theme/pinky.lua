...
local sea_deep = hsl(288, 15, 24) -- you can just type them normally.
...
local sea_foam_triadic = sea_foam.rotate(235)
...
local theme = lush(function()
  return {
    ...
    Comment({ fg = Normal.bg.de(47).li(35).ro(-17) }),
    ...
    -- file.
    LineNrBelow({ LineNr, gui = "underline" }),
    LineNrAbove({ LineNr, bg = hsl(294, 14, 28) }),
