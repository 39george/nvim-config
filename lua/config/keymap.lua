...
vim.keymap.set( "n", "<leader>cdr", function() vim.diagnostic.reset() end, { desc = "Reset Diagnostics" })
vim.keymap.set( "n", "<leader>cdd", vim.diagnostic.open_float, { desc = "Line Diagnostics" })
